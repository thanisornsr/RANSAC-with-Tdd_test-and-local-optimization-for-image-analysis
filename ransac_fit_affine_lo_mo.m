function [A_best,t_best,k_loop,nbr_inlier_best] = ransac_fit_affine_lo_mo(pts, pts_tilde,d, threshold,local_opt_using)
    datasize = length(pts);
    A_best = zeros(2,2);
    t_best = zeros(2,1);
    nbr_inlier_best = 0;
